...
import { jsonFileToFile } from '$lib/core/prototype/collection/upload/util/converter.server.js';
 ...
 */
export const castBase64ToFile = Hooks.beforeUpsert<'upload'>(async function castBase64ToFile(args) {
  let data = args.data;
